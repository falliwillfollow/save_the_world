...
Next work should not be automatic churn. The foundation and optimizer data-contract targets are complete for the micro-commons proof of concept. Future work should test whether the minimum-dignity model scales to 150 and 1500 people, or build the richer visualization against the bundle.
